(module
 ...
 (data (i32.const 944) "XXXXXXXXXXX\00")
 ...
 (data (i32.const 1216) "buy\00")
 (data (i32.const 1232) "no enough eos\00")
 (data (i32.const 1248) "ref bonus\00")
 (data (i32.const 1264) "next hodl\00")
 (data (i32.const 1280) "Bets not equal to amount.\00")
 (data (i32.const 1312) "Already bet.\00")
 (data (i32.const 1328) "only EOS token is allowed\00")
 (data (i32.const 1360) "must buy a positive amount\00")
