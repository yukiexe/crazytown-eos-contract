(module
 ...
 (data (i32.const 672) "Account does not match\00")
 (data (i32.const 704) "Trade id is not found\00")
 (data (i32.const 736) "active\00")
 (data (i32.const 752) "trade cancel successed\00")
 ...
 (data (i32.const 944) "Memo should be a valid asset. Example: 1.2345 KBY\00")
 (data (i32.const 1008) "Ask must be non-EOS\00")
 (data (i32.const 1040) "Ask must be EOS\00")
 ...
 (data (i32.const 1152) "object passed to modify is not in multi_index\00")
 (data (i32.const 1200) "cannot modify objects in table of another contract\00")
 (data (i32.const 1264) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 1328) "Ask mod bid must be 0\00")
 (data (i32.const 1360) "Bid must be non-EOS\00")
 (data (i32.const 1392) "next primary key in table is at autoincrement limit\00")
 ...
 (data (i32.const 1648) "The token has not been whitelisted\00")
