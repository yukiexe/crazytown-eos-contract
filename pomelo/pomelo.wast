(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN6pomelo9cancelbuyEyyy $_ZN6pomelo10cancelsellEyyy)
 (memory $0 1)
 (data (i32.const 4) "\d0f\00\00")
 (data (i32.const 16) "invalid character in symbol name\00")
 (data (i32.const 64) "error reading iterator\00")
 (data (i32.const 96) "read\00")
 (data (i32.const 112) "cannot create objects in table of another contract\00")
 (data (i32.const 176) "Ask must be non-EOS\00")
 (data (i32.const 208) "Bid must be EOS\00")
 ...
 (data (i32.const 512) "Ask must be EOS\00")
 (data (i32.const 528) "Bid must be non-EOS\00")
 ...
 (data (i32.const 880) "Bid mod ask must be 0\00")
 ...
 (data (i32.const 1184) "Ask mod bid must be 0\00")
 (data (i32.const 1216) "Account does not match\00")
 (data (i32.const 1248) "Trade id is not found\00")
 (data (i32.const 1280) "trade cancel successed\00")
 (data (i32.const 1312) "invalid token transfer\00")
 (data (i32.const 1344) "must bet a positive amount\00")
 (data (i32.const 1376) "Memo should be a valid asset. Example: 1.2345 KBY\00")
 ...
 (export "_ZN6pomelo27get_contract_name_by_symbolEy" (func $_ZN6pomelo27get_contract_name_by_symbolEy))
 ...
 (export "_ZN6pomelo12setwhitelistEyy" (func $_ZN6pomelo12setwhitelistEyy))
 (export "_ZN6pomelo15removewhitelistEy" (func $_ZN6pomelo15removewhitelistEy))
 ...
 (func $_ZN6pomelo27get_contract_name_by_symbolEy (param $0 i32) (param $1 i64) (result i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
 ...
 (func $_ZN6pomelo12insert_txlogEyyN5eosio5assetES1_ (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_timestampEvEEEEEEEE7emplaceIZNS1_12insert_txlogEyyNS_5assetESB_E3$_2EENS9_14const_iteratorEyOT_ENKUlRSE_E_clINS9_4itemEEEDaSG_
   (i32.add
    (get_local $7)
    (i32.const 96)
   )
  ...
  (block $label$0
   ...
   (call $_ZNSt3__16vectorIN5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS1_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS4_yXadL_ZNKS4_13get_timestampEvEEEEEEEE8item_ptrENS_9allocatorISC_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINSB_4itemENS_14default_deleteISI_EEEERyRlEEEvDpOT_
    (i32.add
     (get_local $7)
     (i32.const 56)
    )
 ...
 (func $_ZN6pomelo5txlogC2Ev (param $0 i32) (result i32)
  (local $1 i64)
  (local $2 i32)
  (local $3 i32)
  (i64.store offset=24
 ...
 (func $_ZZN5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_timestampEvEEEEEEEE7emplaceIZNS1_12insert_txlogEyyNS_5assetESB_E3$_2EENS9_14const_iteratorEyOT_ENKUlRSE_E_clINS9_4itemEEEDaSG_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  ...
  (block $label$0
   ...
   (block $label$1
    ...
    (drop
     (call $_ZNK5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_timestampEvEEEEEEEE31load_object_by_primary_iteratorEl
      (get_local $4)
      (get_local $5)
     )
    )
     ...
     (select
      ...
      (i64.add
       (tee_local $6
        (i64.load
         (i32.load offset=4
          (call $_ZN5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_timestampEvEEEEEEEE14const_iteratormmEv
           (i32.add
            (get_local $9)
            (i32.const 8)
           )
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS1_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS4_yXadL_ZNKS4_13get_timestampEvEEEEEEEE8item_ptrENS_9allocatorISC_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINSB_4itemENS_14default_deleteISI_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $_ZNK5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_timestampEvEEEEEEEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN5eosio11multi_indexILy14943864954359382016EN6pomelo5txlogEJNS_10indexed_byILy4589987341559704064EN5boost11multi_index13const_mem_funIS2_yXadL_ZNKS2_13get_timestampEvEEEEEEEE14const_iteratormmEv (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (i32.store offset=4
   (i32.const 0)
   ...
   (block $label$1
    (block $label$2
     ...
     (loop $label$3
      ...
      (call $_ZN6pomelo12insert_txlogEyyN5eosio5assetES1_
       (get_local $0)
       (get_local $1)
       (get_local $30)
       (i32.add
 ...
 (func $_ZN6pomelo12setwhitelistEyy (param $0 i32) (param $1 i64) (param $2 i64)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  (call $_ZN6pomelo15removewhitelistEy
   (get_local $0)
   (get_local $1)
  )
  (i32.store
 ...
 (func $_ZN6pomelo15removewhitelistEy (param $0 i32) (param $1 i64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
