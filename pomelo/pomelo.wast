(module
 ...
 (data (i32.const 1344) "Bid mod ask must be 0\00")
 (data (i32.const 1376) "Bid must be EOS\00")
 (data (i32.const 1392) "Ask must be valid\00")
 (data (i32.const 1424) "Bid must be EOS.\00")
 ...
 (data (i32.const 1632) "singleton does not exist\00")
