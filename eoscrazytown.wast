(module
 ...
 (data (i32.const 336) "XXXXXXXXXXX\00")
 (data (i32.const 352) "Invalid token transfer\00")
 (data (i32.const 384) "must have bets in memo\00")
 (data (i32.const 416) "bets wrong\00")
 (data (i32.const 432) "Bets not equal to amount.\00")
 ...
 (data (i32.const 592) "Already bet.\00")
 (data (i32.const 608) "only EOS token is allowed\00")
 (data (i32.const 640) "must bet a positive amount\00")
